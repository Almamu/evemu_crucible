...
public:
    ...
    PyDataType* Query(std::string string, std::vector<int> *searchID, uint32 charID);
    PyDataType* QuickQuery(std::string string, std::vector<int> *searchID, uint32 charID, bool hideNPC = false, bool onlyAltName = false);
