...
public:
    ...
    PyDataType* GetEmploymentRecord(uint32 corpID);
    ...
    PyDataType* GetBulletins(uint32 allyID);
    ...
    static PyDataType *GetMyApplications(uint32 allyID);
    PyDataType *GetApplications(uint32 allyID);

    PyDataType *GetAlliance(uint32 allyID);

    PyDataType* GetContacts(uint32 allyID);
    ...
    PyDataType* GetLabels(uint32 allyID);
    ...
    PyDataType* GetMembers(uint32 allyID);
    PyDataType* GetAllianceMembers(uint32 allyID);
    PyDataType* GetRankedAlliances();
