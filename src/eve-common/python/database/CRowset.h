...
#ifndef __CROWSET_H__
#define __CROWSET_H__
...
public:
     ...
     */
    CRowset (DBRowDescriptor* header);
     ...
     */
    PyPackedRow* insert (std::initializer_list <PyDataType*> values);

    /**
     * @param index The row to get
     * @return The requested row
     */
    PyPackedRow* get (uint32_t index) const;
...
private:
    ...
    static PyDict* _CreateKeywords(DBRowDescriptor* header);
};
