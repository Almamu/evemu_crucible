...
#ifndef __DBROWDESCRIPTOR_H__
#define __DBROWDESCRIPTOR_H__
...
public:
     ...
     */
    const PyString* name (uint32_t index) const;
    /**
     * @param[in] index Index of column type of which should be returned.
     *
     * @return Type of column.
     */
    DBTYPE type (uint32_t index) const;
    /**
     ...
     */
    bool verify (uint32_t index, PyDataType* value);
