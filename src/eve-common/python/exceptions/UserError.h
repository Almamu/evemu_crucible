...
#ifndef __USERERROR_H__
#define __USERERROR_H__
 ...
 */
class UserError : public PyException
{
public:
     ...
     * @return self
     */
    UserError& AddFormatValue (const char* name, PyDataType* value);
...
protected:
     ...
     */
    void AddKeyword( const char* name, PyDataType* value );
     ...
     * @return self
     */
    UserError& AddParameterKeyword (const char* name, UserError_ParameterIDs type, PyDataType* value, PyDataType* value2 = nullptr);
