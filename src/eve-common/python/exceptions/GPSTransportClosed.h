...
#ifndef EVEMU_GPSTRANSPORTCLOSED_H
#define EVEMU_GPSTRANSPORTCLOSED_H
 ...
 * @author Bloody.Rabbit
 */
class GPSTransportClosed : public PyObjectEx_Type1
{
public:
...
#endif //EVEMU_GPSTRANSPORTCLOSED_H
